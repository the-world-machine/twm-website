  ...
  return (
    ...
    <main className='bg-twm'>
      ...
      <div className='font-main my-32 mx-10'>
        ...
        <button onClick={() => window.location.href = '/invite'} className='bg-twm-highlight text-white p-3 rounded-lg hover:cursor-pointer hover:animate-pulse text-3xl my-10'>Invite Now</button>
      </div>
